    ...
    (
            {
                ...
                's_vd': VerticalDatum.WGS84, 't_vd': VerticalDatum.GRS80
            },
    ...
    (
            {
                ...
                's_vd': VerticalDatum.WGS84, 't_vd': VerticalDatum.CGG2013A
            },
            (-123.365646, 48.428421, 0),
    ...
    (
            {
                ...
                's_coords': CoordType.GEOG, 't_coords': CoordType.UTM10,
                's_epoch': 2002, 't_epoch': 2002,
                's_vd': VerticalDatum.WGS84, 't_vd': VerticalDatum.CGG2013
            },
            (-123.365646, 48.428421, 0),
            (472952.272, 5363983.238, 18.969),
            0.001, 0.018
    ...
    (
            {
                ...
                't_vd': VerticalDatum.WGS84, 's_vd': VerticalDatum.CGG2013A
            },
            (472952.272, 5363983.238, 18.969),
            (-123.365646, 48.428421, 0),
            1e-7, 0.018
    ...
    (
            {
                ...
                't_coords': CoordType.GEOG, 's_coords': CoordType.UTM10,
                't_epoch': 2002, 's_epoch': 2002,
                't_vd': VerticalDatum.WGS84, 's_vd': VerticalDatum.CGG2013
            },
            (472952.272, 5363983.238, 18.969),
            (-123.365646, 48.428421, 0),
            1e-7, 0.018
    ...
    (
            {
                ...
                't_vd': VerticalDatum.WGS84, 's_vd': VerticalDatum.HT2_2010v70
            },
            (472952.339, 5363983.280, 18.806),
            (-123.365646, 48.428421, 0),
            1e-7, 0.018
...
def test_csrs_transformer_itrf_to_itrf_transform():
    trans = CSRSTransformer(s_ref_frame=Reference.ITRF14, t_ref_frame=Reference.ITRF00,
                            ...
                            s_vd=VerticalDatum.WGS84, t_vd=VerticalDatum.WGS84
                            )
